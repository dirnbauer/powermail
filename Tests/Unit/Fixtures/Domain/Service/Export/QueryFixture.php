...
class QueryFixture implements QueryInterface
{
    ...
    /**
     * TYPO3 v14 additions to QueryInterface (ordering by dynamic operands)
     */
    ...
    {
        throw new \BadMethodCallException('Not needed for this fixture', 1789216801);
    }

    public function trim(string|DynamicOperandInterface $operand): TrimInterface
    {
        throw new \BadMethodCallException('Not needed for this fixture', 1789216802);
    }

    public function coalesce(string|DynamicOperandInterface ...$operands): CoalesceInterface
    {
        throw new \BadMethodCallException('Not needed for this fixture', 1789216803);
    }
